...
f.spade.bootstrap(
  FUN = f.spade,
  frml.ia = beef_veg ~ fp(age),
  frml.if = beef_veg ~ cs(age),
  data = new_data,
  min.age = 19,
  max.age = 69,
  sex.label = "men",
  ...
  spade.output.path = "12V_SPADE_OUTPUT")
...
f.spade.bootstrap(
  FUN = f.spade,
  frml.ia = eggs_veg ~ fp(age),
  frml.if = eggs_veg ~ cs(age),
  data = new_data,
  min.age = 19,
  max.age = 69,
  sex.label = "both",
...
f.spade.bootstrap(
  FUN = f.spade,
  frml.ia = fish_veg ~ fp(age),
  frml.if = fish_veg ~ cs(age),
  data = new_data,
  min.age = 19,
  max.age = 69,
  sex.label = "both",
